...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "doc_translate": "\u6587\u6863\u7ffb\u8bd1",
        "doc_title": "\u6587\u6863\u6279\u91cf\u7ffb\u8bd1",
        "doc_choose_file": "\u9009\u62e9\u6587\u4ef6",
        "doc_no_file": "\u672a\u9009\u62e9\u6587\u4ef6",
        "doc_output": "\u8f93\u51fa\u6587\u4ef6",
        "doc_start": "\u5f00\u59cb\u7ffb\u8bd1",
        "doc_cancel": "\u53d6\u6d88",
        "doc_open_output": "\u6253\u5f00\u8f93\u51fa\u6587\u4ef6\u5939",
        "doc_progress": "\u8fdb\u5ea6\uff1a{done}/{total}",
        "doc_done": "\u7ffb\u8bd1\u5b8c\u6210\uff1a{path}",
        "doc_failed": "\u7ffb\u8bd1\u5931\u8d25",
        "doc_cancelled": "\u5df2\u53d6\u6d88",
        "doc_select_prompt": "\u8bf7\u5148\u9009\u62e9\u8981\u7ffb\u8bd1\u7684\u6587\u6863",
        "doc_filter": "\u6587\u6863\u6587\u4ef6",
        "doc_output_dir": "\u8f93\u51fa\u76ee\u5f55",
        "doc_output_dir_default": "\uff08\u4e0e\u6e90\u6587\u4ef6\u540c\u76ee\u5f55\uff09",
        "doc_choose_dir": "\u9009\u62e9\u76ee\u5f55",
        "doc_output_format": "\u8f93\u51fa\u683c\u5f0f",
        "fmt_same": "\u4e0e\u6e90\u6587\u4ef6\u76f8\u540c",
        "fmt_txt": "\u7eaf\u6587\u672c (.txt)",
        "fmt_docx": "Word (.docx)",
        "fmt_srt": "\u5b57\u5e55 (.srt)",
        # Answer solver
        "solve": "\u62cd\u9898\u4f5c\u7b54",
        "solve_hint": "\uff08\u5feb\u6377\u952e Ctrl+Alt+X\uff09",
        "solve_result_title": "\u4f5c\u7b54\u7ed3\u679c",
        "solve_question": "\u9898\u76ee",
        "solve_answer": "\u7b54\u6848",
        "solve_explanation": "\u89e3\u6790",
        "solve_solving": "\u6b63\u5728\u4f5c\u7b54...",
        ...
        "server_start": "\u542f\u52a8\u672c\u5730\u670d\u52a1",
        "server_stop": "\u505c\u6b62\u672c\u5730\u670d\u52a1",
        "server_running": "\u670d\u52a1\u5df2\u542f\u52a8 http://127.0.0.1:18190",
        "server_stopped": "\u670d\u52a1\u5df2\u505c\u6b62",
        "server_port": "\u670d\u52a1\u7aef\u53e3",
        "settings_server_port": "\u672c\u5730\u670d\u52a1\u7aef\u53e3",
    ...
    "en": {
        ...
        "doc_translate": "Document translate",
        "doc_title": "Batch document translation",
        "doc_choose_file": "Choose file",
        "doc_no_file": "No file selected",
        "doc_output": "Output file",
        "doc_start": "Start",
        "doc_cancel": "Cancel",
        "doc_open_output": "Open output folder",
        "doc_progress": "Progress: {done}/{total}",
        "doc_done": "Done: {path}",
        "doc_failed": "Translation failed",
        "doc_cancelled": "Cancelled",
        "doc_select_prompt": "Please choose a document first",
        "doc_filter": "Documents",
        "doc_output_dir": "Output folder",
        "doc_output_dir_default": "(same folder as source)",
        "doc_choose_dir": "Choose folder",
        "doc_output_format": "Output format",
        "fmt_same": "Same as source",
        "fmt_txt": "Plain text (.txt)",
        "fmt_docx": "Word (.docx)",
        "fmt_srt": "Subtitle (.srt)",
        "solve": "Solve question",
        "solve_hint": "(Ctrl+Alt+X)",
        "solve_result_title": "Answer",
        "solve_question": "Question",
        "solve_answer": "Answer",
        "solve_explanation": "Explanation",
        ...
        "server_running": "Server running at http://127.0.0.1:18190",
        "server_stopped": "Server stopped",
        "server_port": "Port",
        "settings_server_port": "Local server port",
